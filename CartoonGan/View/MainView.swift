...
final class MainView: UIView {
    ...
    lazy var styleButton: UIButton = {
        let button = UIButton()
        button.setTitle("Select Style ⇲", for: .normal)
        button.layer.borderColor = UIColor.white.cgColor
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            styleButton.topAnchor.constraint(equalTo: topAnchor, constant: 50),
            styleButton.centerXAnchor.constraint(equalTo: centerXAnchor),
            styleButton.heightAnchor.constraint(equalToConstant: 40),
            styleButton.widthAnchor.constraint(equalToConstant: 200),
